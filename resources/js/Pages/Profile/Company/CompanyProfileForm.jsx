      ...
      <input type="file" id="filePhoto" className="sr-only" />
        ...
        <div className="row clearfix">
          <div className="col-lg-6 col-md-12">
            ...
            <InputError message={errors.legalname} className="mt-2" />
              <input
                type="text"
            ...
            <div className="form-group">
                <InputError message={errors.officenumber} className="mt-2" />
              <input type="text" className="form-control" placeholder="Office Number"
              onChange={(e) => setData('officenumber', e.target.value)} 
              name="officenumber"
              />
            </div>
            <div className="form-group">
              <input
                ...
                className="form-control"
                placeholder="P.O Box"
                onChange={(e) => setData('pobox', e.target.value)}
                name="pobox"
              />
            <InputError message={errors.officenumber} className="mt-2" />
            </div>
            <div className="form-group">
              <input
                ...
                name="taxnumber"
              />
              <InputError message={errors.taxnumber} className="mt-2" />
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              <input
                ...
                name="faxnumber"
                onChange={(e) => setData('faxnumber', e.target.value)}
              />
              <InputError message={errors.faxnumber} className="mt-2" />
            </div>
          </div>
          <div className="col-lg-6 col-md-12">
            <div className="form-group">
              ...
              />
              <InputError message={errors.street1} className="mt-2" />
            </div>
            <div className="form-group">
              <input
                type="text"
