...
export default function Profile(){
    return(
        ...
        <div class="container-fluid">
            <Header headerText="Profile" mainNavigate="App" currentPage="Profile"/>
                        ...
                        <ul class="row profile_state list-unstyled">
                            ...
                            <li class="col-lg-6 col-6">
                                <div class="body">
                                    ...
                                    <h5 class="mb-0 number count-to" data-from="0" data-to="251" data-speed="1000" data-fresh-interval="700">251</h5>
                            ...
                            <li class="col-lg-6 col-6">
                                <div class="body">
                                    ...
                                    <h5 class="mb-0 number count-to" data-from="0" data-to="52" data-speed="1000" data-fresh-interval="700">52</h5>
